      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-2 flex-shrink-0">
            <span className="ms-2 fw-bold text-xl text-white font-bold font-serif">
              JobSpace
            </span>
          </div>
          ...
          <div className="hidden md:flex ml-auto space-x-4">
            ...
            <Link
              to="/inscription"
              className="text-blue-950 hover:bg-white hover:text-blue-950 px-3 py-2 rounded-md text-sm font-bold border-2 bg-white font-serif"
            >
              S'inscrire
            </Link>
          </div>
